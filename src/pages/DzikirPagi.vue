  ...
  <div class="dzikir-page">
    ...
    <div class="page-header">
      <div class="header-inner">
        <Sun :size="20" class="header-icon" />
        <div>
          <h1 class="page-title">Dzikir Pagi</h1>
          <p class="page-sub">Dibaca Setelah Subuh - Dhuha</p>
        </div>
      </div>
...
const iframeSrc = computed(() => {
  ...
  return `https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/soundcloud%253Atracks%253A1162445614&color=${encodedColor}&auto_play=true&hide_related=true&show_comments=false&show_user=false&show_reposts=false&show_teaser=true`;
});
</script>
